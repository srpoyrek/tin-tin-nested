 ...
 */
static inline int8_t leaky_relu_i8(
    int8_t x) {
 ...
 */
static inline int8_t hard_tanh_i8(
    int8_t x) {
    return x;
}
 ...
 */
static inline int8_t linear_i8(
    int8_t x) {
    return x;
}
 ...
 */
static inline float leaky_relu_f(
    float x) {
